...
1.  **Acessar o Google Colab:**
    * Acesse [Projeto-Loggi-Logistica](https://colab.research.google.com/github/willcosta29/Analise-de-Hubs-de-distribuicao-regionais-da-LOGGI/blob/main/Projeto_Analise_exploratoria_de_dados.ipynb)
